...
function getContentStructure() {
  return [
    ...
    { id: 'python-zero-to-hero', title: '🐍 Python Zero to Hero (Python + AI/ML)', path: '../guides/PYTHON-ZERO-TO-HERO.md' },
    { id: 'python-aiml-path', title: '↪ AI/ML path (moved)', path: '../guides/PYTHON-AIML-PATH.md' },
