...
function getContentStructure() {
  return [
    ...
    { id: 'dsa-zero-to-hero', title: '📊 DSA Zero to Hero', path: '../data-structures-algorithms-zero-to-hero.md' },
    ...
    { id: 'fullstack-notes', title: '🌐 Full Stack Developer Training', path: '../Full_Stack_Developer_Training_Notes.md' },
